...
// import 'package:segadi/config/router/app_router.dart';
...
//                 // 🔹 REPO ERP
//                 final detailRepository = DetailServiceRepositoryImpl(
//                   api: api,
//                   networkInfo: networkInfo,
//                 );

//                 // 🔹 AIRBAG
//                 final airbagDataSource = AirbagRemoteDataSource(dio);
//                 final airbagRepository = AirbagRepositoryImpl(airbagDataSource);
...
//                   ),
//                   changeStatusUseCase: changeStatusUseCase, // 👈 IMPORTANTE
