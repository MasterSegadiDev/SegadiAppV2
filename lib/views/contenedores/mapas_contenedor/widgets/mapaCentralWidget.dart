...
import 'package:segadi/views/contenedores/mapas_contenedor/widgets/mapa/mapa_ubicaciones_widget.dart';
...
class _ContainerRearrangementScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final movementVm =
        Provider.of<movimientosContenedoresListadoViewModel>(context);
