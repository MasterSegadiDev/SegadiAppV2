...
class ContainersMapScreen extends StatelessWidget {
  ...
  void _showEspaciosModal(
      BuildContext context, String selectedArea, UbicacionesViewModel vm) {
    // Generar combinaciones área + espacio
    final allAreas = vm.getAreas();
    final List<Map<String, String>> combinaciones = [];
    ...
    // Al abrir la modal, limpiamos selección anterior
    final String? selectedAreaDestino = null;
    final String? selectedEspacioDestino = null;
